...
class Game:
    ...
    def instruction(self):
        ...
        lines = [
            "malefactors Ver 1.0",
            "",
            "Mission : kill all malefactors to survive!",
            "Ｏ -- malefactors, chase player step by step.",
            "＃ -- Rock, die malefactors and player when touched. ",
            "＠ -- Player, control for malefactors to crash to rock and survive!",
            "",
            "#Key control:    　    Tenkey:",
            "#７  ８  ９            ７　８  ９",
            "#　↖ ↑  ↗　　　　　　　　↖ ↑  ↗",
            ...
            "#Ｊ  Ｋ  Ｌ　　　　　　１  ２  ３",
            "",
            " 'i' and '5' move malefactors and don't move player",
            "             Good Luck",
            "hit key"
        ]
